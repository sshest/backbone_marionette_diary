        ...
        var Controller = Marionette.Controller.extend({
            drawMenu: function() {
                ...
                if (window.location.hash === ""){
                    ...
                    $('#main-wrapper').html('<div class="start"><h2>Приветствую Вас в "Дневнике" (v. 0.0.1), моем первом одностраничном приложении, предназначеном для хранения самых ярких Ваших переживаний.</h2></div>');
                }   
            }
